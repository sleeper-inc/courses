...
import { ClerkLoaded, ClerkLoading, SignedOut, SignedIn, SignInButton, SignUpButton } from '@clerk/nextjs';
  ...
  return(
    <div className="max-w[988px] mx-auto flex-1 w-full flex flex-col lg:flex-row items-center justify-center">
      <div className="relative w-[240px] h-[240px] lg:w-[424px] lg:h-[424px] lg:mb-0">
        <Image src="/logo.svg" fill alt="Sleeper Inc"/>
      </div>
      <div className="flex flex-col items-center gap-y-8">
        <h1 className="text-xl lg:text-3xl font-bold text-neutral-600 max-w-[480px] text-center">
          Learn, Practice and Master your SQA/QE/TE Knowledge with sleeper Inc.
        </h1>
